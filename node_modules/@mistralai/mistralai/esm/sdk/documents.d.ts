...
export declare class Documents extends ClientSDK {
     ...
     */
    list(request: operations.LibrariesDocumentsListV1Request, options?: RequestOptions): Promise<components.ListDocumentsResponse>;
    /**
     ...
     */
    upload(request: operations.LibrariesDocumentsUploadV1Request, options?: RequestOptions): Promise<components.Document>;
    /**
     ...
     */
    get(request: operations.LibrariesDocumentsGetV1Request, options?: RequestOptions): Promise<components.Document>;
    /**
     ...
     */
    update(request: operations.LibrariesDocumentsPatchV1Request, options?: RequestOptions): Promise<components.Document>;
    /**
     * Update the metadata of a specific document.
     *
     * @remarks
     ...
     */
    librariesDocumentsUpdateV1(request: operations.LibrariesDocumentsUpdateV1Request, options?: RequestOptions): Promise<components.Document>;
    /**
     * Delete a document.
     *
     * @remarks
     ...
     */
    status(request: operations.LibrariesDocumentsGetStatusV1Request, options?: RequestOptions): Promise<components.ProcessingStatus>;
    /**
