...
export declare class FineTuningJobs extends ClientSDK {
    /**
     ...
     */
    list(request?: operations.JobsApiRoutesFineTuningGetFineTuningJobsRequest | undefined, options?: RequestOptions): Promise<components.ListFineTuningJobsResponse>;
    /**
     ...
     */
    create(request: components.CreateFineTuningJobRequest, options?: RequestOptions): Promise<operations.JobsApiRoutesFineTuningCreateFineTuningJobResponse>;
    /**
     * Get Fine Tuning Job
     *
     * @remarks
...
//# sourceMappingURL=finetuningjobs.d.ts.map