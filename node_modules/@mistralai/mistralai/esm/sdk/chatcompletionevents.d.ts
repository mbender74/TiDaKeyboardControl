...
export declare class ChatCompletionEvents extends ClientSDK {
     ...
     */
    search(request: operations.GetChatCompletionEventsV1ObservabilityChatCompletionEventsSearchPostRequest, options?: RequestOptions): Promise<components.SearchChatCompletionEventsResponse>;
    /**
     * Alternative to /search that returns only the IDs and that can return many IDs at once
     */
    searchIds(request: components.SearchChatCompletionEventIdsRequest, options?: RequestOptions): Promise<components.SearchChatCompletionEventIdsResponse>;
    /**
     ...
     */
    fetchSimilarEvents(request: operations.GetSimilarChatCompletionEventsV1ObservabilityChatCompletionEventsEventIdSimilarEventsGetRequest, options?: RequestOptions): Promise<components.SearchChatCompletionEventsResponse>;
    /**
