...
export declare class Datasets extends ClientSDK {
     ...
     */
    create(request: components.CreateDatasetRequest, options?: RequestOptions): Promise<components.Dataset>;
    /**
     * List existing datasets
     */
    list(request?: operations.GetDatasetsV1ObservabilityDatasetsGetRequest | undefined, options?: RequestOptions): Promise<components.ListDatasetsResponse>;
    /**
     * Get dataset by id
     */
     ...
     */
    listRecords(request: operations.GetDatasetRecordsV1ObservabilityDatasetsDatasetIdRecordsGetRequest, options?: RequestOptions): Promise<components.ListDatasetRecordsResponse>;
    /**
     ...
     */
    exportToJsonl(request: operations.ExportDatasetToJsonlV1ObservabilityDatasetsDatasetIdExportsToJsonlGetRequest, options?: RequestOptions): Promise<components.ExportDatasetResponse>;
    /**
     ...
     */
    listTasks(request: operations.GetDatasetImportTasksV1ObservabilityDatasetsDatasetIdTasksGetRequest, options?: RequestOptions): Promise<components.ListDatasetImportTasksResponse>;
}
