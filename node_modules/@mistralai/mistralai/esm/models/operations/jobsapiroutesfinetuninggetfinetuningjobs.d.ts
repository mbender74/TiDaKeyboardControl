 ...
 */
export declare const JobsApiRoutesFineTuningGetFineTuningJobsStatus: {
 ...
 * The current job state to filter on. When set, the other results are not displayed.
 */
export type JobsApiRoutesFineTuningGetFineTuningJobsStatus = ClosedEnum<typeof JobsApiRoutesFineTuningGetFineTuningJobsStatus>;
...
/** @internal */
export declare const JobsApiRoutesFineTuningGetFineTuningJobsStatus$outboundSchema: z.ZodEnum<typeof JobsApiRoutesFineTuningGetFineTuningJobsStatus>;
/** @internal */
...
/** @internal */
export declare const JobsApiRoutesFineTuningGetFineTuningJobsRequest$outboundSchema: z.ZodType<JobsApiRoutesFineTuningGetFineTuningJobsRequest$Outbound, JobsApiRoutesFineTuningGetFineTuningJobsRequest>;
