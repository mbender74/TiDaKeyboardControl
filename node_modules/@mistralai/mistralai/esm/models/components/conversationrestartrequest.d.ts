...
/** @internal */
export declare const ConversationRestartRequestHandoffExecution$outboundSchema: z.ZodEnum<typeof ConversationRestartRequestHandoffExecution>;
/** @internal */
export type ConversationRestartRequestAgentVersion$Outbound = string | number;
/** @internal */
export declare const ConversationRestartRequestAgentVersion$outboundSchema: z.ZodType<ConversationRestartRequestAgentVersion$Outbound, ConversationRestartRequestAgentVersion>;
...
/** @internal */
export declare const ConversationRestartRequest$outboundSchema: z.ZodType<ConversationRestartRequest$Outbound, ConversationRestartRequest>;
