...
/** @internal */
export declare const Loc$inboundSchema: z.ZodType<Loc, unknown>;
export declare function locFromJSON(jsonString: string): SafeParseResult<Loc, SDKValidationError>;
/** @internal */
export declare const Context$inboundSchema: z.ZodType<Context, unknown>;
export declare function contextFromJSON(jsonString: string): SafeParseResult<Context, SDKValidationError>;
/** @internal */
export declare const ValidationError$inboundSchema: z.ZodType<ValidationError, unknown>;
