...
/** @internal */
export const LegacyJobMetadata$inboundSchema = z.object({
...
export function legacyJobMetadataFromJSON(jsonString) {
    return safeParse(jsonString, (x) => LegacyJobMetadata$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'LegacyJobMetadata' from JSON`);
}
//# sourceMappingURL=legacyjobmetadata.js.map