...
/** @internal */
export declare const Resource$inboundSchema: z.ZodType<Resource, unknown>;
export declare function resourceFromJSON(jsonString: string): SafeParseResult<Resource, SDKValidationError>;
/** @internal */
export declare const EmbeddedResource$inboundSchema: z.ZodType<EmbeddedResource, unknown>;
