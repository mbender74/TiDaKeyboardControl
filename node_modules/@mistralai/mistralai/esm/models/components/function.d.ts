...
/** @internal */
export declare const FunctionT$inboundSchema: z.ZodType<FunctionT, unknown>;
/** @internal */
...
/** @internal */
export declare const FunctionT$outboundSchema: z.ZodType<FunctionT$Outbound, FunctionT>;
