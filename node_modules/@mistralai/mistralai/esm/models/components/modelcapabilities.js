...
/** @internal */
export const ModelCapabilities$inboundSchema = z.object({
...
export function modelCapabilitiesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => ModelCapabilities$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'ModelCapabilities' from JSON`);
}
