...
/** @internal */
export declare const RealtimeTranscriptionInputAudioEnd$inboundSchema: z.ZodType<RealtimeTranscriptionInputAudioEnd, unknown>;
/** @internal */
export type RealtimeTranscriptionInputAudioEnd$Outbound = {
    type: "input_audio.end";
};
/** @internal */
export declare const RealtimeTranscriptionInputAudioEnd$outboundSchema: z.ZodType<RealtimeTranscriptionInputAudioEnd$Outbound, RealtimeTranscriptionInputAudioEnd>;
