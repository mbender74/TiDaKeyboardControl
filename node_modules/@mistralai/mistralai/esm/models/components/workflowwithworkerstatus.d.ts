...
/** @internal */
export declare const WorkflowWithWorkerStatus$inboundSchema: z.ZodType<WorkflowWithWorkerStatus, unknown>;
export declare function workflowWithWorkerStatusFromJSON(jsonString: string): SafeParseResult<WorkflowWithWorkerStatus, SDKValidationError>;
//# sourceMappingURL=workflowwithworkerstatus.d.ts.map