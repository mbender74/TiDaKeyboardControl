...
/** @internal */
export declare const MessageOutputEntryContent$inboundSchema: z.ZodType<MessageOutputEntryContent, unknown>;
/** @internal */
export type MessageOutputEntryContent$Outbound = string | Array<MessageOutputContentChunks$Outbound>;
/** @internal */
export declare const MessageOutputEntryContent$outboundSchema: z.ZodType<MessageOutputEntryContent$Outbound, MessageOutputEntryContent>;
...
/** @internal */
export declare const MessageOutputEntry$inboundSchema: z.ZodType<MessageOutputEntry, unknown>;
/** @internal */
...
/** @internal */
export declare const MessageOutputEntry$outboundSchema: z.ZodType<MessageOutputEntry$Outbound, MessageOutputEntry>;
