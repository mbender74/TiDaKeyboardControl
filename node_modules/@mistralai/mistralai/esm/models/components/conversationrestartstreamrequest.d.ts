...
/** @internal */
export declare const ConversationRestartStreamRequestHandoffExecution$outboundSchema: z.ZodEnum<typeof ConversationRestartStreamRequestHandoffExecution>;
/** @internal */
export type ConversationRestartStreamRequestAgentVersion$Outbound = string | number;
/** @internal */
export declare const ConversationRestartStreamRequestAgentVersion$outboundSchema: z.ZodType<ConversationRestartStreamRequestAgentVersion$Outbound, ConversationRestartStreamRequestAgentVersion>;
...
/** @internal */
export declare const ConversationRestartStreamRequest$outboundSchema: z.ZodType<ConversationRestartStreamRequest$Outbound, ConversationRestartStreamRequest>;
