...
export type ChatCompletionRequestTool = Tool | WebSearchTool | WebSearchPremiumTool | CodeInterpreterTool | ImageGenerationTool | DocumentLibraryTool | CustomConnector;
/**
...
/** @internal */
export declare const ChatCompletionRequestStop$outboundSchema: z.ZodType<ChatCompletionRequestStop$Outbound, ChatCompletionRequestStop>;
export declare function chatCompletionRequestStopToJSON(chatCompletionRequestStop: ChatCompletionRequestStop): string;
/** @internal */
export type ChatCompletionRequestMessage$Outbound = (AssistantMessage$Outbound & {
    role: "assistant";
...
/** @internal */
export type ChatCompletionRequestTool$Outbound = Tool$Outbound | WebSearchTool$Outbound | WebSearchPremiumTool$Outbound | CodeInterpreterTool$Outbound | ImageGenerationTool$Outbound | DocumentLibraryTool$Outbound | CustomConnector$Outbound;
/** @internal */
export declare const ChatCompletionRequestTool$outboundSchema: z.ZodType<ChatCompletionRequestTool$Outbound, ChatCompletionRequestTool>;
export declare function chatCompletionRequestToolToJSON(chatCompletionRequestTool: ChatCompletionRequestTool): string;
/** @internal */
