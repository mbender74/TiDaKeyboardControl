...
/** @internal */
export declare const TextChunk$inboundSchema: z.ZodType<TextChunk, unknown>;
/** @internal */
...
/** @internal */
export declare const TextChunk$outboundSchema: z.ZodType<TextChunk$Outbound, TextChunk>;
