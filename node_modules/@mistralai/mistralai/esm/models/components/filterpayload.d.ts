...
/** @internal */
export declare const FilterPayload$inboundSchema: z.ZodType<FilterPayload, unknown>;
/** @internal */
export type FilterPayload$Outbound = {
    filters: FilterCondition$Outbound | FilterGroup$Outbound | null;
};
/** @internal */
export declare const FilterPayload$outboundSchema: z.ZodType<FilterPayload$Outbound, FilterPayload>;
