 ...
 * Get Run History
 */
export function workflowsRunsGetRunHistory(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations
        .GetRunHistoryV1WorkflowsRunsRunIdHistoryGetRequest$outboundSchema
    ...
    const path = pathToFunc("/v1/workflows/runs/{run_id}/history")(pathParams);
...
//# sourceMappingURL=workflowsRunsGetRunHistory.js.map