 ...
 */
export function betaObservabilityJudgesJudgeConversation(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/observability/judges/{judge_id}/live-judging")(pathParams);
...
//# sourceMappingURL=betaObservabilityJudgesJudgeConversation.js.map