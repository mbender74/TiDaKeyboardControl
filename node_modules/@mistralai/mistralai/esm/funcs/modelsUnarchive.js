 ...
 */
export function modelsUnarchive(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/fine_tuning/models/{model_id}/archive")(pathParams);
    ...
    const [result] = await M.match(M.json(200, components.UnarchiveModelResponse$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req);
    if (!result.ok) {
