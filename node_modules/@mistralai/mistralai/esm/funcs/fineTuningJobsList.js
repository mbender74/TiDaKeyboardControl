 ...
 */
export function fineTuningJobsList(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => operations.JobsApiRoutesFineTuningGetFineTuningJobsRequest$outboundSchema
    ...
    const [result] = await M.match(M.json(200, components.ListFineTuningJobsResponse$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req);
    if (!result.ok) {
