 ...
 */
export declare function betaLibrariesAccessesUpdateOrCreate(client: MistralCore, request: operations.LibrariesShareCreateV1Request, options?: RequestOptions): APIPromise<Result<components.Sharing, errors.HTTPValidationError | MistralError | ResponseValidationError | ConnectionError | RequestAbortedError | RequestTimeoutError | InvalidRequestError | UnexpectedClientError | SDKValidationError>>;
