 ...
 */
export function fineTuningJobsCancel(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/fine_tuning/jobs/{job_id}/cancel")(pathParams);
    ...
    const [result] = await M.match(M.json(200, operations
        .JobsApiRoutesFineTuningCancelFineTuningJobResponse$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req);
    if (!result.ok) {
