 ...
 */
export function betaObservabilityChatCompletionEventsJudge(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const path = pathToFunc("/v1/observability/chat-completion-events/{event_id}/live-judging")(pathParams);
...
//# sourceMappingURL=betaObservabilityChatCompletionEventsJudge.js.map