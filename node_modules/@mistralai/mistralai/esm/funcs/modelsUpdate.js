 ...
 */
export function modelsUpdate(client, request, options) {
...
async function $do(client, request, options) {
    ...
    const [result] = await M.match(M.json(200, operations
        .JobsApiRoutesFineTuningUpdateFineTunedModelResponse$inboundSchema), M.fail("4XX"), M.fail("5XX"))(response, req);
    if (!result.ok) {
