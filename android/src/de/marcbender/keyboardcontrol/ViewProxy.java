...
public class ViewProxy extends TiViewProxy
{
	...
	String packageName;
	Resources resources;
	de.marcbender.keyboardcontrol.InsetsAnimationLinearLayout viewWrapper = null;
	...
	private class InteractiveView extends TiUIView
	{
		public InteractiveView(TiViewProxy proxy) {
			...
			viewWrapper = (de.marcbender.keyboardcontrol.InsetsAnimationLinearLayout) inflater.inflate(resId_viewHolder, null);
	        ...
	        if (scrollingViewProxy != null && toolbarViewProxy != null){
				...
				// viewWrapper.addView(scrollingView,scrollingTiView.getLayoutParams());
				// viewWrapper.addView(toolbarview,toolbarTiView.getLayoutParams());
