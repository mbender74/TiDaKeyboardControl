...
// Rare exceptions to indicate a bug in the Keyboardcontroldemo code (e.g., function that a subclass should have implemented)
...
/**
 The base class for Keyboardcontroldemo proxies.
 */
