...
// in simulator we redefine to format for Keyboardcontroldemo Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.keyboardcontroldemo." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.keyboardcontroldemo";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UIKeyboardcontroldemoNativeItemNone = -1,
  UIKeyboardcontroldemoNativeItemSpinner = -2,
  UIKeyboardcontroldemoNativeItemProgressBar = -3,

  UIKeyboardcontroldemoNativeItemSlider = -4,
  UIKeyboardcontroldemoNativeItemSwitch = -5,
  UIKeyboardcontroldemoNativeItemMultiButton = -6,
  UIKeyboardcontroldemoNativeItemSegmented = -7,

  UIKeyboardcontroldemoNativeItemTextView = -8,
  UIKeyboardcontroldemoNativeItemTextField = -9,
  UIKeyboardcontroldemoNativeItemSearchBar = -10,

  UIKeyboardcontroldemoNativeItemPicker = -11,
  UIKeyboardcontroldemoNativeItemDatePicker = -12,

  UIKeyboardcontroldemoNativeItemInfoLight = -13,
  UIKeyboardcontroldemoNativeItemInfoDark = -14,

  UIKeyboardcontroldemoNativeItemDisclosure = -15,

  UIKeyboardcontroldemoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Keyboardcontroldemo instances of
