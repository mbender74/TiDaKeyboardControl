...
/**
 Base class for all Keyboardcontroldemo views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the Keyboardcontroldemo view hierarchy (such as wrapped iOS UIViews) was touched.
